...
export default function Reports() {
  ...
  const printExecutiveReport = () => {
    ...
    html += `<div class="cover">
      <div class="cover-label">WARROOM — Red Team Intelligence Platform</div>
    ...
    html += `<div class="footer">
      <span>WARROOM — Structured Red Team Intelligence Platform</span>
  ...
  const exportChainMarkdown = () => {
    ...
    lines.push(`*Generated by WARROOM — Structured Red Team Intelligence Platform*`);
  ...
  const exportScenarioPdf = () => {
    ...
    win.document.write(`
      ...
      <div class="footer">Generated by WARROOM — Structured Red Team Intelligence Platform</div>
      </body></html>
    `);
    win.document.close();
    win.focus();
  ...
  const printReport = () => {
    ...
    let html = `<html><head><title>${session.name} — WARROOM Report</title><style>
    ...
    if (selectedSections.has('cover')) {
      html += `<h1>WARROOM SESSION REPORT</h1>
    ...
    html += `<div class="footer">Generated by WARROOM — Structured Red Team Intelligence Platform — ${new Date().toLocaleDateString()}</div>`;
  ...
  const exportMarkdown = () => {
    ...
    if (selectedSections.has('cover')) {
      lines.push(`# WARROOM SESSION REPORT`);
  ...
  const printAgentReport = () => {
    ...
    html += `<div class="footer">
      <span>WARROOM — Red Team Intelligence Platform</span>
      <span>CONFIDENTIAL — ${new Date().toLocaleDateString()}</span>
    </div>`;
